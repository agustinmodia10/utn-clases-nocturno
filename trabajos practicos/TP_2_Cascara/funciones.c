...
int validarminymax(int min, int max)
{
    int val;
    scanf("%d",&val);
...
void alta(iper people[])
{
    ...
    if(oel != -1)
    {
        ...
        auxa = validarminymax(1000000, 90000000);
        ...
        if(!enc)
		{
            ...
            printf("\n  Ingrese edad: ");
            people[oel].age = validarminymax(1, 99);
 ...
 */
    ...
    auxb = validarminymax(1000000, 90000000);
